...
for i0 = 1 : snr_cnt
    ...
    while FER(i0)<max_err_cnt && gen_seq_cnt(i0)<max_gen_seq
        ...
        [~,rec_seq_HD]=max(LLR_2, [],1); rec_seq_HD = rec_seq_HD-1;
        nd = sum(rec_seq_HD~=code_seq);
        ...
        if gen_seq_cnt(i0)==last_refresh_cnt
            ...
            last_refresh_cnt = last_refresh_cnt+max_err_cnt-1;
            figure(1)
            ...
            lgnd = [fl_nm '_' num2str(max_iter) '_Iter'];
